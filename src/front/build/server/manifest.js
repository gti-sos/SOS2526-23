...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/5-C6nMK5dO.js')),
			__memo(() => import('./chunks/6-BeridMBh.js')),
			__memo(() => import('./chunks/7-BOVrztXz.js')),
			__memo(() => import('./chunks/8-pAVjRJxD.js')),
			__memo(() => import('./chunks/9-CQKumXm4.js'))
		],
		remotes: {
